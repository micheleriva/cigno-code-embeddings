...
LANGUAGE_CONFIG: dict[str, LanguageConfig] = {
    ...
    "ocaml": LanguageConfig(
        ...
        extensions=[".ml", ".mli"],
        function_nodes=["let_binding", "value_definition"],
        class_nodes=["type_definition", "module_definition"],
        doc_comment_node="comment",
    ...
    "fortran": LanguageConfig(
        ...
        function_nodes=["function", "subroutine"],
        class_nodes=["module", "derived_type_definition"],
        doc_comment_node="comment",
    ),
    "sql": LanguageConfig(
        name="sql",
        ...
        extensions=[".sql"],
        function_nodes=["create_function_statement"],
        class_nodes=["create_table_statement"],
        doc_comment_node="comment",
    ),
    "objc": LanguageConfig(
        name="objc",
        ...
        class_nodes=["class_interface", "class_implementation", "protocol_declaration"],
        doc_comment_node="comment",
        name_field="declarator",
    ),
